...
public class AdaptiveHeroFragment extends Fragment {
    ...
    private ConstraintSet getMediumLayout(@NonNull ConstraintSet smallLayout) {
        int marginHorizontal = getResources().getDimensionPixelOffset(R.dimen.hero_margin);
        int noMargin = getResources().getDimensionPixelOffset(R.dimen.margin_none);
        int marginHorizontalAdditional =
                getResources()
                        .getDimensionPixelOffset(R.dimen.hero_margin_horizontal_additional);
